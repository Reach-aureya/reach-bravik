    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            REACH Bravik acts as a bridge between design, production, merchandising, and marketing teams. Everyone works with the same structured documents, ensuring alignment across departments. This reduces miscommunication and helps teams move faster from concept to final product.
          </p>
