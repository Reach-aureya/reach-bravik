    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Well-structured catalogs, line sheets, and presentation decks make it easier for buyers and stakeholders to understand your collection. Clean layouts and organized information help highlight key products, making presentations more persuasive and improving chances of conversions.
          </p>
