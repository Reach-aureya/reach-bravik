    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            The platform supports professional export options such as print-ready PDFs with bleed, crop marks, and color profiles. This ensures that catalogs, packaging, and printed materials come out exactly as designed. At the same time, digital PDFs can be used for sharing with teams, vendors, and clients.
          </p>
