    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            With control over typography, colors, layouts, and templates, every document—from tech packs to catalogs and packaging—follows the same visual identity. This consistency strengthens your brand image and ensures that all communication looks professional and aligned across teams and markets.
          </p>
