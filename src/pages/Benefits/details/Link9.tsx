    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Professional and well-designed documentation reflects your brand’s capability and reliability. Buyers and partners are more confident working with companies that present clear, detailed, and polished documents, giving you a competitive advantage in global markets.
          </p>
