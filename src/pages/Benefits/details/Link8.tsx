    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            All your documents—tech packs, catalogs, packaging designs—become part of a structured archive. This helps teams reuse past designs, learn from previous collections, and onboard new team members more efficiently with clear references.
          </p>
