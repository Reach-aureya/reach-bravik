    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Using reusable templates, master pages, and layout systems, teams can quickly update designs for new seasons or collections. Instead of creating documents from scratch, only key details like colorways, dimensions, or styles need to be updated, saving significant time and effort.
          </p>
